...
export function SalonSwitcher({ 
  ...
  // Helper to get a plan badge color (we'll derive this from salon data if available)
  const getPlanBadgeColor = () => {
    // For now, default to purple gradient since plan is not in Salon type
            ...
            {salons.map((salon) => (
              ...
              >
                {salon.logo ? (
                  ...
                  <div className={`w-10 h-10 rounded-lg ${getPlanBadgeColor()} flex items-center justify-center flex-shrink-0`}>
